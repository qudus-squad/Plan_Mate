...
class InvalidToAddProjectException : Exception()
class InvalidToGetByIdProjectException : Exception()
class InvalidToGetAllLException : Exception()
class InvalidToDeleteProjectException : Exception()
class InvalidToEditProjectException : Exception()
