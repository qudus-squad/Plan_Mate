...
class CreateNewTaskUseCaseTest {
    ...
    fun setup() {
        ...
        createNewTaskUseCase = CreateNewTaskUseCase(taskRepository)
    }
    ...
    @Test
    fun `createNewTask should should throw EmptyValuesException when title has empty value`(){
        // Given
        val task = Task(
            title = "",
            description = "some notes",
    ...
    @Test
    fun `createNewTask should should throw EmptyValuesException when project id has empty value`(){
        // Given
        val task = Task(
            title = "Note",
            description = "some notes",
    ...
    @Test
    fun `createNewTask should should throw EmptyValuesException when creator id has empty value`(){
        // Given
        val task = Task(
            title = "Note",
            description = "some notes",
